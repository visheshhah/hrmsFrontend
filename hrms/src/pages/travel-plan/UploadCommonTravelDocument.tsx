...
import { getCommonTravelDocuments, getDocumentTypes, getEmployeeDocuments, getEmployeeDocumentsByEmployeeId, uploadTravelDocument, type DocumentType, type TravelDocumentResponse, type UploadTravelDocumentRequest } from "../../api/document.api";
